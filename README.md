...
## v1.15 visual update
Built directly from the user-supplied, verified-working v1.14 package. Authentication, Firebase initialisation, sync, Firestore paths and UID-specific storage remain unchanged. Only the requested home-screen presentation was updated.
