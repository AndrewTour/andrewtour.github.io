...
function openOffDayContactSearch(){homeQuickProspectorReturn=true;setProspectorSection('contacts');switchView('prospectingView');requestAnimationFrame(()=>$('#prospectSearch')?.focus({preventScroll:true}))}
