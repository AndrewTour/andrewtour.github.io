...
function runOffDayQuickAction(action=''){
  if(action==='call'){openManualDialler();return}if(action==='task'){openTaskComposer();return}if(action==='appointment'){openOffDayQuickAppointment();return}if(action==='calendar'){openCalendar();return}if(action==='broadcast')openOffDayBroadcast()
}
