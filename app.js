...
function renderScorecard(){
  ...
  if(ins.avgKnock!=null){const diff=ins.avgKnock-14*60;rec.push(diff>0?`Your average knock start is ${diff} minutes later than the 2:00 pm target.`:`Your average knock start is on or ahead of the 2:00 pm target.`)}
