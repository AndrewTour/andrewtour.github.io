...
for(const asset of ['cleanup.css?v=1.38.3-buyer-full-viewport','app.js?v=1.38.3-buyer-full-viewport']){assert(index.includes(asset));assert(sw.includes(asset))}
...
console.log('PASS: baseline regressions plus task persistence, daily stats formatting, restored vCard export, end-of-day Send Stats, shortcut removal, team-task rules, cache references and PWA assets.');
