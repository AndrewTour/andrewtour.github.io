/* AGNT 1.44.15: independent startup protection; no authentication or data access. */
(()=>{
  'use strict';
  const version='1.44.15',key='agnt:runtime-events-v1',boot=Date.now().toString(36);
