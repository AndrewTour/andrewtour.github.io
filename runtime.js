/* AGNT 1.41.41: independent startup protection; no authentication or data access. */
(()=>{
  'use strict';
  const version='1.41.41',key='agnt:runtime-events-v1',boot=Date.now().toString(36);
