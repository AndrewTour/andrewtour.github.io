/* AGNT 1.44.17: independent startup protection; no authentication or data access. */
(()=>{
  'use strict';
  const version='1.44.17',key='agnt:runtime-events-v1',boot=Date.now().toString(36);
