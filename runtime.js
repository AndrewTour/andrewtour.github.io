/* AGNT 1.44.11: independent startup protection; no authentication or data access. */
(()=>{
  'use strict';
  const version='1.44.11',key='agnt:runtime-events-v1',boot=Date.now().toString(36);
