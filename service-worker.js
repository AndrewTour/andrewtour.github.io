const CACHE='agnt-v1.56.8-safe-sync-efficiency';
const ASSETS=['./','./index.html','./styles.css?v=1.56.8','./app.js?v=1.56.8','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
