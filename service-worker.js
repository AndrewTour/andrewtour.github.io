const CACHE='agnt-v1.36.47-hot-spotting-message-action';
const ASSETS=['./','./index.html','./styles.css?v=1.36.47-hot-spotting-message-action','./app.js?v=1.36.47-hot-spotting-message-action','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
