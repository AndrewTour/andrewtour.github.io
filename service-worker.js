const CACHE='agnt-v68-typography-motion';
const ASSETS=['./','./index.html','./styles.css?v=68','./app.js?v=68','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
