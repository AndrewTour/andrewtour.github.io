const CACHE='agnt-v73-1-contact-timeline';
const ASSETS=['./','./index.html','./styles.css?v=73.1','./app.js?v=73.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
