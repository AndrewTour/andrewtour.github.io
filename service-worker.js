const CACHE='agnt-v1.38.9-subheading-date-correction';
const ASSETS=['./','./index.html','./styles.css?v=1.38.9','./app.js?v=1.38.9','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
