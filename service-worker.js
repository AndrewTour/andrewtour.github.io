const CACHE='agnt-v1.41.13-balanced-right-now';
const ASSETS=['./','./index.html','./styles.css?v=1.41.13-balanced-right-now','./app.js?v=1.41.13-balanced-right-now','./cleanup.css?v=1.41.13-balanced-right-now','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
