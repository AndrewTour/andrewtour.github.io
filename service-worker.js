const CACHE='agnt-v95-3-saturday-timeline';
const ASSETS=['./','./index.html','./styles.css?v=95.3','./app.js?v=95.3','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
