const CACHE='agnt-beta-v1.36.40-market-ui-cohesion';
const ASSETS=['./','./index.html','./styles.css?v=1.36.40-beta-market-ui-cohesion','./app.js?v=1.36.40-beta-market-ui-cohesion','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
