const CACHE='agnt-v1.56.5-session-metrics-fix';
const ASSETS=['./','./index.html','./styles.css?v=1.56.5','./app.js?v=1.56.5','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
