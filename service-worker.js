const CACHE='agnt-v125-7-session-colour-fix';
const ASSETS=['./','./index.html','./styles.css?v=125.7-session-colour-fix','./app.js?v=125.7-session-colour-fix','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
