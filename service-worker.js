const CACHE='agnt-beta-v1.36.39-overlay-clarity';
const ASSETS=['./','./index.html','./styles.css?v=1.36.39-beta-overlay-clarity','./app.js?v=1.36.39-beta-overlay-clarity','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
