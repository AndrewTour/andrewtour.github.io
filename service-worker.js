const CACHE='agnt-v114-1-today-layout-fix';
const ASSETS=['./','./index.html','./styles.css?v=114.1','./app.js?v=114.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
