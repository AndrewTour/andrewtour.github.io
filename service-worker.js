const CACHE='agnt-v114-today-page-log';
const ASSETS=['./','./index.html','./styles.css?v=114-today-log','./app.js?v=114-today-log','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
