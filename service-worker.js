const CACHE='agnt-v2.0.0-prospector';
const ASSETS=['./','./index.html','./styles.css?v=2.0.0','./app.js?v=2.0.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
