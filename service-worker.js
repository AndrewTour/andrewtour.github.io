const CACHE='agnt-v1.40.0-consistency-orchestration';
const ASSETS=['./','./index.html','./styles.css?v=1.40.0-consistency-orchestration','./app.js?v=1.40.0-consistency-orchestration','./cleanup.css?v=1.40.0-consistency-orchestration','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
