const CACHE='agnt-beta-v1.36.36-market-insights-context';
const ASSETS=['./','./index.html','./styles.css?v=1.36.36-beta-market-insights-context','./app.js?v=1.36.36-beta-market-insights-context','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
