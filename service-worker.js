const CACHE='agnt-v1.37.0-stability-core';
const ASSETS=['./','./index.html','./styles.css?v=1.37.0-stability-core','./app.js?v=1.37.0-stability-core','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
