const CACHE='agnt-v1.37.5-micro-stability';
const ASSETS=['./','./index.html','./styles.css?v=1.37.5-micro-stability','./app.js?v=1.37.5-micro-stability','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
