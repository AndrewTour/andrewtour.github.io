const CACHE='agnt-v81-leaderboard-restore';
const ASSETS=['./','./index.html','./styles.css?v=81-design-system-sprint4','./app.js?v=81-design-system-sprint4','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
