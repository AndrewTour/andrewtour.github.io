const CACHE='agnt-v76-welcome-timeline';
const ASSETS=['./','./index.html','./styles.css?v=75','./app.js?v=75','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
