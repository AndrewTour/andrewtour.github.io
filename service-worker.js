const CACHE='agnt-v1.38.1-shared-focus';
const ASSETS=['./','./index.html','./styles.css?v=1.38.1','./app.js?v=1.38.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
