const CACHE='agnt-v1.41.9-buyer-session-resume';
const ASSETS=['./','./index.html','./styles.css?v=1.41.9-buyer-session-resume','./app.js?v=1.41.9-buyer-session-resume','./cleanup.css?v=1.41.9-buyer-session-resume','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
