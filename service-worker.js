const CACHE='agnt-beta-v1.36.34-time-sensitive-buyer-alerts';
const ASSETS=['./','./index.html','./styles.css?v=1.36.34-beta-time-sensitive-buyer-alerts','./app.js?v=1.36.34-beta-time-sensitive-buyer-alerts','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
