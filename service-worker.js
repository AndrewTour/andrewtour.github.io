const CACHE='agnt-v95-6-archive-outcome';
const ASSETS=['./','./index.html','./styles.css?v=95.6','./app.js?v=95.6','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
