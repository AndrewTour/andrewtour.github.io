const CACHE='agnt-v119-3-week-appointments-refinement';
const ASSETS=['./','./index.html','./styles.css?v=119.3-week-appointments-refinement','./app.js?v=119.3-week-appointments-refinement','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
