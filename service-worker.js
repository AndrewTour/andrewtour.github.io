const CACHE='agnt-v1.56.2-contact-management';
const ASSETS=['./','./index.html','./styles.css?v=1.56.2','./app.js?v=1.56.2','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
