const CACHE='agnt-v110-doorknocking-session-resume';
const ASSETS=['./','./index.html','./styles.css?v=110','./app.js?v=110','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
