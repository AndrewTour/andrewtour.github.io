const CACHE='agnt-v1.38.7-contextual-compact-leaderboard';
const ASSETS=['./','./index.html','./styles.css?v=1.38.7','./app.js?v=1.38.7','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
