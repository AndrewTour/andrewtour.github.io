const CACHE='agnt-v114-4-offday-review';
const ASSETS=['./','./index.html','./styles.css?v=114.4-offday-review','./app.js?v=114.4-offday-review','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
