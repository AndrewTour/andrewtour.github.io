const CACHE='agnt-v1.41.11-universal-call-prompt';
const ASSETS=['./','./index.html','./styles.css?v=1.41.11-universal-call-prompt','./app.js?v=1.41.11-universal-call-prompt','./cleanup.css?v=1.41.11-universal-call-prompt','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
