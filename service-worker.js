const CACHE='agnt-v95-4-auction-line';
const ASSETS=['./','./index.html','./styles.css?v=95.4','./app.js?v=95.4','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
