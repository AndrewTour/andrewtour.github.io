const CACHE='agnt-v1.39.0-subheading-date-correction';
const ASSETS=['./','./index.html','./styles.css?v=1.39.0','./app.js?v=1.39.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
