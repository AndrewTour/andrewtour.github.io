const CACHE='agnt-v111-daily-knocking-home-return-agent-summary';
const ASSETS=['./','./index.html','./styles.css?v=111','./app.js?v=111','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
