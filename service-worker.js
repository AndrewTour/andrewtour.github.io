const CACHE='agnt-v1.38.1-review-stats';
const ASSETS=['./','./index.html','./styles.css?v=1.38.1-review-stats','./app.js?v=1.38.1-review-stats','./cleanup.css?v=1.38.1-review-stats','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
