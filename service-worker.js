const CACHE='agnt-v82-2-approved-welcome';
const ASSETS=['./','./index.html','./styles.css?v=82.2','./app.js?v=82.2','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
