const CACHE='agnt-beta-v1.36.35-appointment-intelligence';
const ASSETS=['./','./index.html','./styles.css?v=1.36.35-appointment-intelligence','./app.js?v=1.36.35-appointment-intelligence','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
