const CACHE='agnt-v1.36.52-bex-visual-system';
const ASSETS=['./','./index.html','./styles.css?v=1.36.52-bex-visual-system','./ui-system.css?v=1.36.52-bex-visual-system','./app.js?v=1.36.52-bex-visual-system','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
