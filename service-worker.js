const CACHE='agnt-v125-3-hot-spotting-progress';
const ASSETS=['./','./index.html','./styles.css?v=125.3-hot-spotting-progress','./app.js?v=125.3-hot-spotting-progress','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
