const CACHE='agnt-v1.39.0-seller-intelligence';
const ASSETS=['./','./index.html','./styles.css?v=1.39.0-seller-intelligence','./app.js?v=1.39.0-seller-intelligence','./cleanup.css?v=1.39.0-seller-intelligence','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
