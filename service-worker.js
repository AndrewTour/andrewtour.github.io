const CACHE='agnt-v1.41.17-off-day-cleanup';
const ASSETS=['./','./index.html','./styles.css?v=1.41.17-off-day-cleanup','./app.js?v=1.41.17-off-day-cleanup','./cleanup.css?v=1.41.17-off-day-cleanup','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
