const CACHE='agnt-v1.41.15-home-viewport-balance';
const ASSETS=['./','./index.html','./styles.css?v=1.41.15-home-viewport-balance','./app.js?v=1.41.15-home-viewport-balance','./cleanup.css?v=1.41.15-home-viewport-balance','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
