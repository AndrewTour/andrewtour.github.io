const CACHE='agnt-v1.37.1-knocking-flow';
const ASSETS=['./','./index.html','./styles.css?v=1.37.1-knocking-flow','./app.js?v=1.37.1-knocking-flow','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
