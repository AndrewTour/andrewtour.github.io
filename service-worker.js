const CACHE='agnt-v74-timeline-ui-1';
const ASSETS=['./','./index.html','./styles.css?v=74-timeline-ui-1','./app.js?v=74-timeline-ui-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
