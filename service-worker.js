const CACHE='agnt-v78-subtle-motion';
const ASSETS=['./','./index.html','./styles.css?v=78','./app.js?v=78','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
