const CACHE='agnt-v1.38.2-buyer-legibility';
const ASSETS=['./','./index.html','./styles.css?v=1.38.2-buyer-legibility','./app.js?v=1.38.2-buyer-legibility','./cleanup.css?v=1.38.2-buyer-legibility','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
