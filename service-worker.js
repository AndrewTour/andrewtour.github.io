const CACHE='agnt-v72-prospecting-intelligence';
const ASSETS=['./','./index.html','./styles.css?v=72','./app.js?v=72','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
