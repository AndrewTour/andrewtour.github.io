const CACHE='agnt-v1.36.50-hot-spotting-records';
const ASSETS=['./','./index.html','./styles.css?v=1.36.50-hot-spotting-records','./app.js?v=1.36.50-hot-spotting-records','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
