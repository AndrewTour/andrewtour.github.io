const CACHE='agnt-v1.38.0-workflow-polish';
const ASSETS=['./','./index.html','./styles.css?v=1.38.0-workflow-polish','./app.js?v=1.38.0-workflow-polish','./cleanup.css?v=1.38.0-workflow-polish','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
