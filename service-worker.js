const CACHE='agnt-v1.37.2-marketpulse-hub';
const ASSETS=['./','./index.html','./styles.css?v=1.37.2-marketpulse-hub','./app.js?v=1.37.2-marketpulse-hub','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
