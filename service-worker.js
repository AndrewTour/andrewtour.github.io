const CACHE='agnt-v95-7-archived-back';
const ASSETS=['./','./index.html','./styles.css?v=95.7','./app.js?v=95.7','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
