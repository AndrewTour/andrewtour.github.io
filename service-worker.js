const CACHE='agnt-v119-2-ui-refinement';
const ASSETS=['./','./index.html','./styles.css?v=119.2-ui-refinement','./app.js?v=119.2-ui-refinement','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
