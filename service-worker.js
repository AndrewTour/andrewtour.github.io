const CACHE='agnt-v1.36.49-hot-spotting-hierarchy';
const ASSETS=['./','./index.html','./styles.css?v=1.36.49-hot-spotting-hierarchy','./app.js?v=1.36.49-hot-spotting-hierarchy','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
