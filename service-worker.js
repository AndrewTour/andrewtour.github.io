const CACHE='agnt-v83-language-alignment';
const ASSETS=['./','./index.html','./styles.css?v=83.0','./app.js?v=83.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
