const CACHE='agnt-v1.41.19-day-off-home';
const ASSETS=['./','./index.html','./styles.css?v=1.41.19-day-off-home','./app.js?v=1.41.19-day-off-home','./cleanup.css?v=1.41.19-day-off-home','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
