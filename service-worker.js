const CACHE='agnt-v1.37.3-marketpulse-followups';
const ASSETS=['./','./index.html','./styles.css?v=1.37.3-marketpulse-followups','./app.js?v=1.37.3-marketpulse-followups','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
