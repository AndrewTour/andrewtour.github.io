const CACHE='agnt-v1.41.18-buyer-pattern-home';
const ASSETS=['./','./index.html','./styles.css?v=1.41.18-buyer-pattern-home','./app.js?v=1.41.18-buyer-pattern-home','./cleanup.css?v=1.41.18-buyer-pattern-home','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
