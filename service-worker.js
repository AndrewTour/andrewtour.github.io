const CACHE='agnt-v1.39.1-contact-property-details';
const ASSETS=['./','./index.html','./styles.css?v=1.39.1-contact-property-details','./app.js?v=1.39.1-contact-property-details','./cleanup.css?v=1.39.1-contact-property-details','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
