const CACHE='agnt-v1.56.7-session-interface-fix';
const ASSETS=['./','./index.html','./styles.css?v=1.56.7','./app.js?v=1.56.7','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
