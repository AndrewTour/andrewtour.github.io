const CACHE='agnt-v1.41.10-simple-return-state';
const ASSETS=['./','./index.html','./styles.css?v=1.41.10-simple-return-state','./app.js?v=1.41.10-simple-return-state','./cleanup.css?v=1.41.10-simple-return-state','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
