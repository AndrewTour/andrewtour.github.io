const CACHE='agnt-v114-today-day-log';
const ASSETS=['./','./index.html','./styles.css?v=114-log','./app.js?v=114-log','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
