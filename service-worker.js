const CACHE='agnt-v1.37.9-device-contacts';
const ASSETS=['./','./index.html','./styles.css?v=1.37.9-device-contacts','./app.js?v=1.37.9-device-contacts','./cleanup.css?v=1.37.9-device-contacts','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
