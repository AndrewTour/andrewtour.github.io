const CACHE='agnt-v114-3-agent-summary';
const ASSETS=['./','./index.html','./styles.css?v=114.3-agent-summary','./app.js?v=114.3-agent-summary','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
