const CACHE='agnt-beta-v1.36.31-buyer-matching';
const ASSETS=['./','./index.html','./styles.css?v=1.36.31-beta-buyer-matching','./app.js?v=1.36.31-beta-buyer-matching','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
