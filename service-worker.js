const CACHE='agnt-v87-clickable-appointment-cards';
const ASSETS=['./','./index.html','./styles.css?v=87.0','./app.js?v=87.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
