const CACHE='agnt-v1.41.25-calendar-quick-action';
const ASSETS=['./','./index.html','./styles.css?v=1.41.25-calendar-quick-action','./app.js?v=1.41.25-calendar-quick-action','./cleanup.css?v=1.41.25-calendar-quick-action','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
