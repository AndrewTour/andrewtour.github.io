const CACHE='agnt-v103-1-1-session-fix';
const ASSETS=['./','./index.html','./styles.css?v=103.1.1','./app.js?v=103.1.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
