const CACHE='agnt-v109-doorknocking-session';
const ASSETS=['./','./index.html','./styles.css?v=109','./app.js?v=109','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
