const CACHE='agnt-v1.36.51-hot-spotting-skip';
const ASSETS=['./','./index.html','./styles.css?v=1.36.51-hot-spotting-skip','./app.js?v=1.36.51-hot-spotting-skip','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
