const CACHE='agnt-v1.41.0-seller-next-best-action';
const ASSETS=['./','./index.html','./styles.css?v=1.41.0-seller-next-best-action','./app.js?v=1.41.0-seller-next-best-action','./cleanup.css?v=1.41.0-seller-next-best-action','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
