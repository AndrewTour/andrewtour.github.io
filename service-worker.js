const CACHE='agnt-v1.38.3-buyer-full-viewport';
const ASSETS=['./','./index.html','./styles.css?v=1.38.3-buyer-full-viewport','./app.js?v=1.38.3-buyer-full-viewport','./cleanup.css?v=1.38.3-buyer-full-viewport','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
