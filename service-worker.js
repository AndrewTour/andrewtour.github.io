const CACHE='agnt-v75-leaderboard-stats-1';
const ASSETS=['./','./index.html','./styles.css?v=75-lb-stats-1','./app.js?v=75-lb-stats-1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
