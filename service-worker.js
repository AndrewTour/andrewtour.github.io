const CACHE='agnt-v125-4-hot-spotting-session-fix';
const ASSETS=['./','./index.html','./styles.css?v=125.4-hot-spotting-session-fix','./app.js?v=125.4-hot-spotting-session-fix','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
