const CACHE='agnt-v125-7-passkey-poc1';
const ASSETS=['./','./index.html','./styles.css?v=125.7-passkey-poc1','./app.js?v=125.7-passkey-poc1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
