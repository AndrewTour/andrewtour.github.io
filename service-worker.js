const CACHE='agnt-v1.39.3-contact-profile-full-viewport';
const ASSETS=['./','./index.html','./styles.css?v=1.39.3-contact-profile-full-viewport','./app.js?v=1.39.3-contact-profile-full-viewport','./cleanup.css?v=1.39.3-contact-profile-full-viewport','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
