const CACHE='agnt-v1.41.27-hotspot-sms-flow';
const ASSETS=['./','./index.html','./styles.css?v=1.41.27-hotspot-sms-flow','./app.js?v=1.41.27-hotspot-sms-flow','./cleanup.css?v=1.41.27-hotspot-sms-flow','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
