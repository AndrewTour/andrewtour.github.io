const CACHE='agnt-v107-appointment-session-refinement';
const ASSETS=['./','./index.html','./styles.css?v=107','./app.js?v=107','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
