const CACHE='agnt-v1.36.46-hot-spotting-bulk-sms';
const ASSETS=['./','./index.html','./styles.css?v=1.36.46-hot-spotting-bulk-sms','./app.js?v=1.36.46-hot-spotting-bulk-sms','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
