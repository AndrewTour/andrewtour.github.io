const CACHE='agnt-v114-2-smart-log-phase1';
const ASSETS=['./','./index.html','./styles.css?v=114.2-smart-log','./app.js?v=114.2-smart-log','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
