const CACHE='agnt-v1.56.8.1-login-initialisation-fix';
const ASSETS=['./','./index.html','./styles.css?v=1.56.8.1','./app.js?v=1.56.8.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
