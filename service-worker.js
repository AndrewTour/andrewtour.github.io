const CACHE='agnt-v1.41.26-weekly-appointments-seller-actions';
const ASSETS=['./','./index.html','./styles.css?v=1.41.26-weekly-appointments-seller-actions','./app.js?v=1.41.26-weekly-appointments-seller-actions','./cleanup.css?v=1.41.26-weekly-appointments-seller-actions','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
