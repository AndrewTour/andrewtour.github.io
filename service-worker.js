const CACHE='agnt-v1.38.5-unified-leaderboard';
const ASSETS=['./','./index.html','./styles.css?v=1.38.5','./app.js?v=1.38.5','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
