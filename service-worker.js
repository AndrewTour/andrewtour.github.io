const CACHE='agnt-v1.38.8-shared-metric-header';
const ASSETS=['./','./index.html','./styles.css?v=1.38.8','./app.js?v=1.38.8','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
