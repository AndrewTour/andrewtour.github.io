const CACHE='agnt-v125-6-prospector-session-states';
const ASSETS=['./','./index.html','./styles.css?v=125.6-prospector-session-states','./app.js?v=125.6-prospector-session-states','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
