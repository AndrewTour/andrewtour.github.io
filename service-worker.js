const CACHE='agnt-v114-focus-timeline-dropdown';
const ASSETS=['./','./index.html','./styles.css?v=114-timeline','./app.js?v=114-timeline','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
