const CACHE='agnt-v1.41.14-stability-trust';
const ASSETS=['./','./index.html','./styles.css?v=1.41.14-stability-trust','./app.js?v=1.41.14-stability-trust','./cleanup.css?v=1.41.14-stability-trust','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
