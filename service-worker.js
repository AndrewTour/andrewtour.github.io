const CACHE='agnt-v1.38.1-metrics-first-knocking';
const ASSETS=['./','./index.html','./styles.css?v=1.38.1-metrics-first-knocking','./app.js?v=1.38.1-metrics-first-knocking','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
