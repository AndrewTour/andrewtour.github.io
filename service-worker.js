const CACHE='agnt-v1.55.0-prospector-visual-foundation';
const ASSETS=['./','./index.html','./styles.css?v=1.55.0','./app.js?v=1.55.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
