const CACHE='agnt-v90-isolated-appointment-editor';
const ASSETS=['./','./index.html','./styles.css?v=90.0','./app.js?v=90.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
