const CACHE='agnt-v71-beta-feedback-refinement';
const ASSETS=['./','./index.html','./styles.css?v=71','./app.js?v=71','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
