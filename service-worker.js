const CACHE='agnt-v1.56.3-contacts-header-cleanup';
const ASSETS=['./','./index.html','./styles.css?v=1.56.3','./app.js?v=1.56.3','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
