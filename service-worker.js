const CACHE='agnt-v1.41.16-off-day-conversations';
const ASSETS=['./','./index.html','./styles.css?v=1.41.16-off-day-conversations','./app.js?v=1.41.16-off-day-conversations','./cleanup.css?v=1.41.16-off-day-conversations','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
