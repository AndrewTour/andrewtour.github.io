const CACHE='agnt-v95-10-copy-case';
const ASSETS=['./','./index.html','./styles.css?v=95.10','./app.js?v=95.10','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
