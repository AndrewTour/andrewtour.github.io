const CACHE='agnt-v86-review-on-today';
const ASSETS=['./','./index.html','./styles.css?v=86.0','./app.js?v=86.0','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
