const CACHE='agnt-v93-1-prospector-today-corrections';
const ASSETS=['./','./index.html','./styles.css?v=93.1','./app.js?v=93.1','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
