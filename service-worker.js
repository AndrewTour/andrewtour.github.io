const CACHE='agnt-v112-daily-knocking-totals';
const ASSETS=['./','./index.html','./styles.css?v=112','./app.js?v=112','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
