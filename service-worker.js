const CACHE='agnt-v106-appointment-contact-flow';
const ASSETS=['./','./index.html','./styles.css?v=106','./app.js?v=106','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
