const CACHE='agnt-v108-leaderboard-appointments';
const ASSETS=['./','./index.html','./styles.css?v=108','./app.js?v=108','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
