const CACHE='agnt-v119-4-week-overview-appointment-rows';
const ASSETS=['./','./index.html','./styles.css?v=119.4-week-overview-appointment-rows','./app.js?v=119.4-week-overview-appointment-rows','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
