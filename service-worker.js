const CACHE='agnt-v1.41.12-buyer-call-return';
const ASSETS=['./','./index.html','./styles.css?v=1.41.12-buyer-call-return','./app.js?v=1.41.12-buyer-call-return','./cleanup.css?v=1.41.12-buyer-call-return','./firebase-config.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
